...
#ifndef CORAL_DETAIL_FILEUTILDETAIL_H_
#define CORAL_DETAIL_FILEUTILDETAIL_H_
 ...
 */
namespace coral { namespace fileutil_detail {
...
#endif /* CORAL_DETAIL_FILEUTILDETAIL_H_ */
