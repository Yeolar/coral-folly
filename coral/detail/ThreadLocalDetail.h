...
#ifndef CORAL_DETAIL_THREADLOCALDETAIL_H_
#define CORAL_DETAIL_THREADLOCALDETAIL_H_
...
#define CORAL_TLD_USE_CORAL_TLS 1
#else
#undef CORAL_TLD_USE_CORAL_TLS
#endif
...
struct StaticMeta {
...
#ifdef CORAL_TLD_USE_CORAL_TLS
  static CORAL_TLS ThreadEntry threadEntry_;
#endif
...
#ifndef CORAL_TLD_USE_CORAL_TLS
    // Allocated in getThreadEntry() when not using coral TLS; free it
    delete threadEntry;
#endif
  }
  ...
  static void reserve(uint32_t id) {
    ...
    // Growth factor < 2, see coral/docs/FBVector.md; + 5 to prevent
    // very slow start.
...
#ifdef CORAL_TLD_USE_CORAL_TLS
template <class Tag>
CORAL_TLS ThreadEntry StaticMeta<Tag>::threadEntry_ = {nullptr, 0,
                                                       nullptr, nullptr};
#endif
...
#endif /* CORAL_DETAIL_THREADLOCALDETAIL_H_ */
