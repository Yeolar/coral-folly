...
#ifndef CORAL_DETAIL_UNCAUGHTEXCEPTIONCOUNTER_H_
#define CORAL_DETAIL_UNCAUGHTEXCEPTIONCOUNTER_H_

#include <exception>

#if defined(__GNUG__) || defined(__CLANG__)
#define CORAL_EXCEPTION_COUNT_USE_CXA_GET_GLOBALS
...
#define CORAL_EXCEPTION_COUNT_USE_GETPTD
...
#elif defined(CORAL_EXCEPTION_COUNT_USE_GETPTD)
...
#endif /* CORAL_DETAIL_UNCAUGHTEXCEPTIONCOUNTER_H_ */
