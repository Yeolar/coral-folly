...
#ifndef CORAL_DETAIL_CACHELOCALITY_H_
#define CORAL_DETAIL_CACHELOCALITY_H_
...
struct CacheLocality {
  ...
  enum {
    ...
    /// Sandy Bridge).  See CORAL_ALIGN_TO_AVOID_FALSE_SHARING
    kFalseSharingRange = 128
  };

  static_assert(kFalseSharingRange == 128,
      "CORAL_ALIGN_TO_AVOID_FALSE_SHARING should track kFalseSharingRange");
};
...
#define CORAL_ALIGN_TO_AVOID_FALSE_SHARING CORAL_ALIGNED(128)
...
struct SequentialThreadId {
 ...
 private:
  ...
  static CORAL_TLS size_t currentId;
};
...
#endif /* CORAL_DETAIL_CacheLocality_H_ */
