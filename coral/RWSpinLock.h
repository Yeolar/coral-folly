...
#ifndef CORAL_RWSPINLOCK_H_
#define CORAL_RWSPINLOCK_H_
...
#if defined(__GNUC__) && \
  (defined(__i386) || CORAL_X64 || \
   defined(ARCH_K8))
# define RW_SPINLOCK_USE_X86_INTRINSIC_
# include <x86intrin.h>
#elif defined(_MSC_VER) && defined(CORAL_X64)
# define RW_SPINLOCK_USE_X86_INTRINSIC_
#else
...
#if (CORAL_SSE >= 2) && !TARGET_OS_IPHONE
