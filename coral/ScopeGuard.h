...
#ifndef CORAL_SCOPEGUARD_H_
#define CORAL_SCOPEGUARD_H_
...
#include <coral/detail/UncaughtExceptionCounter.h>
...
#if defined(CORAL_EXCEPTION_COUNT_USE_CXA_GET_GLOBALS) || \
    defined(CORAL_EXCEPTION_COUNT_USE_GETPTD)
...
#define SCOPE_EXIT \
  auto CR_ANONYMOUS_VARIABLE(SCOPE_EXIT_STATE) \
  = ::coral::detail::ScopeGuardOnExit() + [&]() noexcept

#if defined(CORAL_EXCEPTION_COUNT_USE_CXA_GET_GLOBALS) || \
    defined(CORAL_EXCEPTION_COUNT_USE_GETPTD)
#define SCOPE_FAIL \
  auto CR_ANONYMOUS_VARIABLE(SCOPE_FAIL_STATE) \
  = ::coral::detail::ScopeGuardOnFail() + [&]() noexcept

#define SCOPE_SUCCESS \
  auto CR_ANONYMOUS_VARIABLE(SCOPE_SUCCESS_STATE) \
  = ::coral::detail::ScopeGuardOnSuccess() + [&]()
#endif // native uncaught_exception() supported

#endif // CORAL_SCOPEGUARD_H_
