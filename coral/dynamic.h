 ...
 *     ;
 *
 * Also see coral/json.h for the serialization and deserialization
 * functions for JSON.
 *
 ...
 *     empty array.
 *
 * Additional documentation is in coral/docs/Dynamic.md.
 *
 * @author Jordan DeLong <delong.j@fb.com>
 */

#ifndef CORAL_DYNAMIC_H_
#define CORAL_DYNAMIC_H_
