 ...
 * coral/docs/small_vector.md
 *
 * @author Jordan DeLong <delong.j@fb.com>
 */
#ifndef CORAL_SMALL_VECTOR_H_
#define CORAL_SMALL_VECTOR_H_
...
#if defined(__GNUC__) && CORAL_X64
# include <coral/SmallLocks.h>
# define CR_PACK_ATTR CORAL_PACK_ATTR
# define CR_PACK_PUSH CORAL_PACK_PUSH
# define CR_PACK_POP CORAL_PACK_POP
#else
# define CR_PACK_ATTR
# define CR_PACK_PUSH
# define CR_PACK_POP
...
#if CORAL_HAVE_MALLOC_SIZE
  extern "C" std::size_t malloc_size(const void*);
# if !CORAL_HAVE_MALLOC_USABLE_SIZE
