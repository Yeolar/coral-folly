...
#ifndef CORAL_FORMATARG_H_
#define CORAL_FORMATARG_H_
...
struct FormatArg {
   ...
   * arguments to enforce, formatted using coral::to<std::string>.
   */
  ...
  template <typename... Args>
  CORAL_NORETURN void error(Args&&... args) const;
