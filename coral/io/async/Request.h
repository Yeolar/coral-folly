...
class RequestContext {
 public:
  ...
  void setContextData(
    ...
    coral::RWSpinLock::WriteHolder guard(lock);
  ...
  bool hasContextData(const std::string& val) {
    coral::RWSpinLock::ReadHolder guard(lock);
 ...
 private:
  ...
  static std::shared_ptr<RequestContext> &getStaticContext() {
    static coral::ThreadLocal<std::shared_ptr<RequestContext> > context;
    return *context;
  }

  coral::RWSpinLock lock;
