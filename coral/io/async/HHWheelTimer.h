 ...
 */
class HHWheelTimer : private coral::AsyncTimeout,
 ...
 public:
  ...
  explicit HHWheelTimer(coral::EventBase* eventBase,
  ...
  bool isDetachable() const {
    return !coral::AsyncTimeout::isScheduled();
  }

  using coral::AsyncTimeout::attachEventBase;
  using coral::AsyncTimeout::detachEventBase;
  using coral::AsyncTimeout::getTimeoutManager;
