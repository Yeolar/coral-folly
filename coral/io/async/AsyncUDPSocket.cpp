...
void AsyncUDPSocket::bind(const coral::SocketAddress& address) {
  ...
  auto g = coral::makeGuard([&] { ::close(socket); });
...
ssize_t AsyncUDPSocket::write(const coral::SocketAddress& address,
...
ssize_t AsyncUDPSocket::writev(const coral::SocketAddress& address,
