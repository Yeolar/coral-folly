...
void splitTest() {
  ...
  coral::split(',', StringPiece("a,b,c"), parts);
  EXPECT_EQ(parts.size(), 3);
  EXPECT_EQ(parts[0], "a");
  EXPECT_EQ(parts[1], "b");
  EXPECT_EQ(parts[2], "c");
  ...
  coral::split(',', string("a,b,c"), parts);
  EXPECT_EQ(parts.size(), 3);
  EXPECT_EQ(parts[0], "a");
  EXPECT_EQ(parts[1], "b");
  EXPECT_EQ(parts[2], "c");
  ...
  coral::split(',', "a,,c", parts, true);
  EXPECT_EQ(parts.size(), 2);
  EXPECT_EQ(parts[0], "a");
  EXPECT_EQ(parts[1], "c");
  parts.clear();

  coral::split(',', string("a,,c"), parts, true);
  EXPECT_EQ(parts.size(), 2);
  EXPECT_EQ(parts[0], "a");
  EXPECT_EQ(parts[1], "c");
  parts.clear();
  ...
  coral::split("ab", "dabcabkdbkab", parts, true);
  EXPECT_EQ(parts.size(), 3);
  EXPECT_EQ(parts[0], "d");
  EXPECT_EQ(parts[1], "c");
  ...
  coral::split("bc", "abcd", parts, true);
  EXPECT_EQ(parts.size(), 2);
  EXPECT_EQ(parts[0], "a");
  EXPECT_EQ(parts[1], "d");
  parts.clear();
  ...
  coral::split("", orig, parts, true);
  EXPECT_EQ(parts.size(), 1);
  EXPECT_EQ(parts[0], orig);
  parts.clear();

  coral::split("452x;o38asfsajsdlfdf.j", "asfds", parts, true);
  EXPECT_EQ(parts.size(), 1);
  EXPECT_EQ(parts[0], "asfds");
  parts.clear();

  coral::split("a", "", parts, true);
  ...
  coral::split("a", StringPiece(), parts, true);
  EXPECT_EQ(parts.size(), 0);
  parts.clear();

  coral::split("a", StringPiece(), parts);
  EXPECT_EQ(parts.size(), 1);
  EXPECT_EQ(parts[0], "");
  parts.clear();

  coral::split("a", "abcdefg", parts, true);
  EXPECT_EQ(parts.size(), 1);
...
void piecesTest() {
  ...
  // test splits that with multi-line delimiter
  coral::split("ab", "dabcabkdbkab", pieces, true);
  EXPECT_EQ(pieces.size(), 3);
  ...
  string orig = "ab2342asdfv~~!";
  coral::split("", orig.c_str(), pieces, true);
  EXPECT_EQ(pieces.size(), 1);
  EXPECT_EQ(pieces[0], orig);
  pieces.clear();

  coral::split("452x;o38asfsajsdlfdf.j", "asfds", pieces, true);
  EXPECT_EQ(pieces.size(), 1);
  EXPECT_EQ(pieces[0], "asfds");
  pieces.clear();

  coral::split("a", "", pieces, true);
  EXPECT_EQ(pieces.size(), 0);
  pieces.clear();

  coral::split("a", "", pieces);
  EXPECT_EQ(pieces.size(), 1);
  EXPECT_EQ(pieces[0], "");
  pieces.clear();

  coral::split("a", "abcdefg", pieces, true);
  EXPECT_EQ(pieces.size(), 1);
  EXPECT_EQ(pieces[0], "bcdefg");
  pieces.clear();

  orig = "All, , your base, are , , belong to us";
  coral::split(", ", orig, pieces, true);
  EXPECT_EQ(pieces.size(), 4);
  ...
  const char* str = "a,b";
  coral::split(',', StringPiece(str), pieces);
  EXPECT_EQ(pieces.size(), 2);
  EXPECT_EQ(pieces[0], "a");
  EXPECT_EQ(pieces[1], "b");
  ...
  coral::splitTo<StringPiece>(":", "asd:bsd:asd:asd:bsd:csd::asd",
...
TEST(Split, split_fbvector) {
  splitTest<coral::fbvector>();
}
TEST(Split, pieces_vector) {
  piecesTest<std::vector>();
}
TEST(Split, pieces_fbvector) {
  piecesTest<coral::fbvector>();
}

TEST(Split, fixed) {
  StringPiece a, b, c, d;

  EXPECT_TRUE(coral::split<false>('.', "a.b.c.d", a, b, c, d));
  EXPECT_TRUE(coral::split<false>('.', "a.b.c", a, b, c));
  EXPECT_TRUE(coral::split<false>('.', "a.b", a, b));
  EXPECT_TRUE(coral::split<false>('.', "a", a));

  EXPECT_TRUE(coral::split('.', "a.b.c.d", a, b, c, d));
  EXPECT_TRUE(coral::split('.', "a.b.c", a, b, c));
  EXPECT_TRUE(coral::split('.', "a.b", a, b));
  EXPECT_TRUE(coral::split('.', "a", a));

  EXPECT_TRUE(coral::split<false>('.', "a.b.c", a, b, c));
  EXPECT_EQ("a", a);
  EXPECT_EQ("b", b);
  EXPECT_EQ("c", c);
  EXPECT_FALSE(coral::split<false>('.', "a.b", a, b, c));
  EXPECT_TRUE(coral::split<false>('.', "a.b.c", a, b));
  EXPECT_EQ("a", a);
  EXPECT_EQ("b.c", b);
  ...
  EXPECT_EQ("b", b);
  EXPECT_EQ("c", c);
  EXPECT_FALSE(coral::split('.', "a.b.c", a, b));
  EXPECT_FALSE(coral::split('.', "a.b", a, b, c));

  EXPECT_TRUE(coral::split<false>('.', "a.b", a, b));
  EXPECT_EQ("a", a);
  EXPECT_EQ("b", b);
  EXPECT_FALSE(coral::split<false>('.', "a", a, b));
  EXPECT_TRUE(coral::split<false>('.', "a.b", a));
  EXPECT_EQ("a.b", a);

  EXPECT_TRUE(coral::split('.', "a.b", a, b));
  EXPECT_EQ("a", a);
  EXPECT_EQ("b", b);
  EXPECT_FALSE(coral::split('.', "a", a, b));
  EXPECT_FALSE(coral::split('.', "a.b", a));
}
...
TEST(Split, fixed_convert) {
  ...
  EXPECT_TRUE(coral::split(':', "a:13:14.7:b", a, b, c, d));
  EXPECT_EQ("a", a);
  EXPECT_EQ(13, b);
  EXPECT_NEAR(14.7, c, 1e-10);
  EXPECT_EQ("b", d);

  EXPECT_TRUE(coral::split<false>(':', "b:14:15.3:c", a, b, c, d));
  EXPECT_EQ("b", a);
  EXPECT_EQ(14, b);
  EXPECT_NEAR(15.3, c, 1e-10);
  EXPECT_EQ("c", d);

  EXPECT_FALSE(coral::split(':', "a:13:14.7:b", a, b, d));

  EXPECT_TRUE(coral::split<false>(':', "a:13:14.7:b", a, b, d));
  EXPECT_EQ("a", a);
  EXPECT_EQ(13, b);
  EXPECT_EQ("14.7:b", d);

  EXPECT_THROW(coral::split<false>(':', "a:13:14.7:b", a, b, c),
               std::range_error);
}
...
BENCHMARK(splitOnSingleCharFixedAllowExtra, iters) {
  ...
  for (size_t i = 0; i < iters << 4; ++i) {
    StringPiece a, b, c, d;
    coral::split<false>(':', line, a, b, c, d);
  }
}
