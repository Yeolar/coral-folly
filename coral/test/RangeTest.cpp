...
namespace coral { namespace detail {
...
#if CORAL_HAVE_CONSTEXPR_STRLEN
...
void split_step_with_process_noop(coral::StringPiece) {}
...
TEST(StringPiece, split_step_with_process_char_delimiter) {
  ...
  EXPECT_EQ(1, (p.split_step(' ', [&](coral::StringPiece x) {
    EXPECT_EQ(std::next(s, 5), p.begin());
    EXPECT_EQ(e, p.end());
    EXPECT_EQ("this", x);
    return 1;
  ...
  EXPECT_EQ(2, (p.split_step(' ', [&](coral::StringPiece x) {
    EXPECT_EQ(std::next(s, 8), p.begin());
    EXPECT_EQ(e, p.end());
    EXPECT_EQ("is", x);
    return 2;
  ...
  EXPECT_EQ(3, (p.split_step('u', [&](coral::StringPiece x) {
    EXPECT_EQ(std::next(s, 10), p.begin());
    EXPECT_EQ(e, p.end());
    EXPECT_EQ("j", x);
    return 3;
  ...
  EXPECT_EQ(4, (p.split_step(' ', [&](coral::StringPiece x) {
    EXPECT_EQ(std::next(s, 13), p.begin());
    EXPECT_EQ(e, p.end());
    EXPECT_EQ("st", x);
    return 4;
  ...
  EXPECT_EQ(5, (p.split_step(' ', [&](coral::StringPiece x) {
    EXPECT_EQ(std::next(s, 14), p.begin());
    EXPECT_EQ(e, p.end());
    EXPECT_EQ("", x);
    return 5;
  ...
  EXPECT_EQ(6, (p.split_step(' ', [&](coral::StringPiece x) {
    EXPECT_EQ(std::next(s, 16), p.begin());
    EXPECT_EQ(e, p.end());
    EXPECT_EQ("a", x);
    return 6;
  ...
  EXPECT_EQ(7, (p.split_step(' ', [&](coral::StringPiece x) {
    EXPECT_EQ(std::next(s, 21), p.begin());
    EXPECT_EQ(e, p.end());
    EXPECT_EQ("test", x);
    return 7;
  ...
  EXPECT_EQ(8, (p.split_step(' ', [&](coral::StringPiece x) {
    EXPECT_EQ(e, p.begin());
    EXPECT_EQ(e, p.end());
    EXPECT_EQ("string", x);
    return 8;
  ...
  EXPECT_EQ(9, (p.split_step(' ', [&](coral::StringPiece x) {
    EXPECT_EQ(e, p.begin());
    EXPECT_EQ(e, p.end());
    EXPECT_EQ("", x);
    return 9;
...
TEST(StringPiece, split_step_with_process_range_delimiter) {
  ...
  EXPECT_EQ(10, (p.split_step("  ", [&](coral::StringPiece x) {
    EXPECT_EQ(e, p.begin());
    EXPECT_EQ(e, p.end());
    EXPECT_EQ("", x);
    return 10;
...
TEST(StringPiece, split_step_with_process_char_delimiter_additional_args) {
  ...
  auto const functor = [](
    coral::StringPiece s,
    coral::StringPiece expected
  ) {
    EXPECT_EQ(expected, s);
    return expected;
  };

  auto const checker = [&](coral::StringPiece expected) {
...
TEST(StringPiece, NoInvalidImplicitConversions) {
  struct IsString {
    bool operator()(coral::Range<int*>) { return false; }
    bool operator()(coral::StringPiece) { return true; }
  };
...
TEST(qfind, UInt32_Ranges) {
  ...
  auto a_range = coral::Range<const uint32_t*>(&a[0], a.size());
  auto b_range = coral::Range<const uint32_t*>(&b[0], b.size());
