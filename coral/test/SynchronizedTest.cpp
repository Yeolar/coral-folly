...
// Test bed for coral/Synchronized.h

#include <coral/Synchronized.h>
#include <coral/RWSpinLock.h>
#include <coral/test/SynchronizedTestLib.h>
...
TEST(Synchronized, Basic) {
  ...
  testBasic<coral::RWTicketSpinLock32>();
#endif
...
#ifdef RW_SPINLOCK_USE_X86_INTRINSIC_
  testConcurrency<coral::RWTicketSpinLock32>();
#endif
...
#ifdef RW_SPINLOCK_USE_X86_INTRINSIC_
  testDualLocking<coral::RWTicketSpinLock32>();
#endif
...
#ifdef RW_SPINLOCK_USE_X86_INTRINSIC_
  testDualLockingWithConst<coral::RWTicketSpinLock32>();
#endif
