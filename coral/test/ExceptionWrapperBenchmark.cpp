...
BENCHMARK_RELATIVE(exception_wrapper_create_and_test, iters) {
  std::runtime_error e("payload");
  for (size_t i = 0; i < iters; ++i) {
    auto ew = coral::make_exception_wrapper<std::runtime_error>(e);
    assert(ew);
  }
}
...
/*
_bin/coral/test/exception_wrapper_benchmark --bm_min_iters=100000
============================================================================
coral/test/ExceptionWrapperBenchmark.cpp        relative  time/iter  iters/s
============================================================================
