...
#ifndef CORAL_TEST_SYNCHRONIZEDTESTLIB_H
#define CORAL_TEST_SYNCHRONIZEDTESTLIB_H

// We have mutex types outside of coral that we want to test with Synchronized.
...
#include <coral/test/SynchronizedTestLib-inl.h>

#endif /* CORAL_TEST_SYNCHRONIZEDTESTLIB_H */
