...
TEST(LifoSem, no_blocking) {
  long seed = coral::randomNumberSeed() % 10000;
  LOG(INFO) << "seed=" << seed;
...
// sudo nice -n -20 coral/test/LifoSemTests --benchmark --bm_min_iters=10000000
// ============================================================================
// coral/test/LifoSemTests.cpp                     relative  time/iter  iters/s
// ============================================================================
