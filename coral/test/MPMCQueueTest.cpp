...
CORAL_ASSUME_FBVECTOR_COMPATIBLE_1(boost::intrusive_ptr);
...
TEST(MPMCQueue, lots_of_element_types) {
  ...
  runElementTypeTest(coral::make_unique<char>('a'));
...
static CORAL_TLS int lc_counts[MAX_LIFECYCLE_EVENT];
static CORAL_TLS int lc_prev[MAX_LIFECYCLE_EVENT];
