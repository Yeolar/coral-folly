...
#ifndef CORAL_EXCEPTION_H_
#define CORAL_EXCEPTION_H_
...
CORAL_NORETURN void throwSystemErrorExplicit(int err, const char*);
inline void throwSystemErrorExplicit(int err, const char* msg) {
  throw std::system_error(err, std::system_category(), msg);
}

template <class... Args>
CORAL_NORETURN void throwSystemErrorExplicit(int, Args&&... args);
template <class... Args>
...
template <class... Args>
CORAL_NORETURN void throwSystemError(Args&&... args);
template <class... Args>
...
#define CHECK_THROW(cond, E) \
  ::coral::throwOnFail<E>((cond), "Check failed: " #cond)

}  // namespace coral

#endif /* CORAL_EXCEPTION_H_ */
