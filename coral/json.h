...
/**
 *
 * Serialize and deserialize coral::dynamic values as JSON.
 *
...
#ifndef CORAL_JSON_H_
#define CORAL_JSON_H_
...
namespace json {
  ...
  /*
   * Main JSON serialization routine taking coral::dynamic parameters.
   * For the most common use cases there are simpler functions in the
   * main coral namespace below.
   */
