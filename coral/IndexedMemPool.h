...
#ifndef CORAL_INDEXEDMEMPOOL_H
#define CORAL_INDEXEDMEMPOOL_H
...
struct IndexedMemPool : boost::noncopyable {
 ...
 private:
  ...
  struct CORAL_ALIGN_TO_AVOID_FALSE_SHARING LocalList {
  ...
  CORAL_ALIGN_TO_AVOID_FALSE_SHARING Slot* slots_;
  ...
  CORAL_ALIGN_TO_AVOID_FALSE_SHARING AtomicStruct<TaggedPtr,Atom> globalHead_;
