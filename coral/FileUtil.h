...
#ifndef CORAL_FILEUTIL_H_
#define CORAL_FILEUTIL_H_
...
bool readFile(const char* file_name, Container& out,
  ...
  out.resize(
    std::min(
      buf.st_size > 0 ? coral::to<size_t>(buf.st_size + 1) : initialAlloc,
      num_bytes));
