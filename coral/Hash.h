...
#ifndef CORAL_BASE_HASH_H_
#define CORAL_BASE_HASH_H_
...
namespace coral { namespace hash {
...
namespace std {
  ...
  public:
    size_t operator()(const std::pair<T1, T2>& x) const {
      return coral::hash::hash_combine(x.first, x.second);
    }
  };
